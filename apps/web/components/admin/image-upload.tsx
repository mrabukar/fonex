...
export function ImageUpload({
  ...
  async function saveImage() {
    ...
    setUploading(true);
    try {
      const { uploadUrl: presignedUrl, imageUrl: newImageUrl } = await apiClient.post<{
        uploadUrl: string;
        imageUrl: string;
      }>(uploadUrl, { contentType: pendingFile.type });
            ...
            <div className="flex w-full min-w-0 flex-col gap-3">
              ...
              {imageUrl && (
                <div className="flex items-center gap-2">
                  ...
                  <ImageThumbnail src={imageUrl} size="sm" />
                </div>
              )}
        ...
        <div className="flex flex-col gap-3">
          {imageUrl ? (
            <div className="flex items-center gap-3">
              <ImageThumbnail src={imageUrl} size="lg" />
