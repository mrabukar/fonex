    ...
    <div>
      ...
      >
        <div
          ...
          style={{
            background:
              "radial-gradient(45% 70% at 80% 20%, rgba(47,91,255,.35), transparent 60%), radial-gradient(40% 60% at 15% 90%, rgba(108,92,231,.3), transparent 60%)",
          }}
        />
        <div
          className="absolute inset-0"
      ...
      <Container as="section" className="py-[74px]">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
          <div>
            ...
            <p
              className="text-[16.5px] leading-[1.7] mb-4"
              style={{ color: "#4C566F" }}
            >
              Fonex Supply Limited is a premier supplier of smartphones, mobile
              devices, and accessories. We specialize in importing,
              distributing, and delivering authentic products from global
              brands.
            </p>
            <p
              ...
              style={{ color: "#4C566F" }}
            >
              From our base in Somalia, we&apos;ve positioned ourselves as a
              dependable link between the world&apos;s leading manufacturers and
              the retailers, businesses, and people of East Africa.
            </p>
          </div>
            ...
            {[
              ...
              >
                ...
                <div
                  ...
                  style={{ color: stat.dark ? "#A9B2CC" : "#5A6480" }}
                >
                  {stat.label}
                </div>
              </div>
          ...
          >
            <div
              ...
              style={{
                ...
                background: "#2F5BFF",
                color: "#fff",
                boxShadow: "0 8px 20px rgba(47,91,255,.3)",
              }}
            >
              <Shield size={22} strokeWidth={2} />
            </div>
            <div
              className="font-bold text-[14px] tracking-[.06em] uppercase mb-3"
              style={{ color: "#2F5BFF", fontFamily: "var(--font-sora)" }}
            >
              Our Mission
            </div>
            <p
            ...
            >
              To empower individuals and businesses by supplying innovative
              smartphones and accessories that enhance communication,
              productivity, and digital inclusion — through high-quality mobiles
              and spare parts.
            </p>
          </div>
          ...
          >
            ...
            <div
              ...
              style={{
                ...
                background: "#FFB020",
                color: "#fff",
                boxShadow: "0 8px 20px rgba(255,176,32,.3)",
              }}
            >
            ...
            <div
              className="font-bold text-[14px] tracking-[.06em] uppercase mb-3"
              style={{ color: "#FFB020", fontFamily: "var(--font-sora)" }}
            >
              Our Vision
            </div>
            <p
              className="relative font-bold text-balance"
              style={{
                fontFamily: "var(--font-sora)",
                fontSize: 23,
                lineHeight: 1.35,
            ...
            >
              To become East Africa&apos;s most trusted mobile supply company —
              recognized for reliability, affordability, and excellence in
              customer service.
            </p>
          </div>
        </Container>
      ...
      >
        <div
          ...
          style={{
            background:
              "radial-gradient(40% 60% at 85% 30%, rgba(47,91,255,.25), transparent 60%)",
          }}
        />
        <Container className="relative py-[74px]">
          ...
          <h2
            className="font-extrabold text-white max-w-[600px] mb-12"
            style={{
              fontFamily: "var(--font-sora)",
              fontSize: 36,
              lineHeight: 1.12,
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {milestones.map((m) => (
              <div key={m.tag} className="relative">
                <div className="flex items-center gap-3 mb-4">
                  <span
                    style={{
                      ...
                      borderRadius: "50%",
                      background: "#2F5BFF",
                      boxShadow: "0 0 0 5px rgba(47,91,255,.2)",
                      display: "block",
                      flexShrink: 0,
                    }}
                  />
                ...
                <div
                  className="text-[15.5px] leading-[1.55] font-medium"
                  style={{ color: "#C3CADD" }}
                >
                  {m.text}
                </div>
