    ...
    <div>
      ...
      <section style={{ background: "#fff", borderBottom: "1px solid #E7EAF3" }}>
        <Container className="pt-14 pb-11">
          ...
          <h1
            className="font-extrabold text-balance max-w-[680px]"
            style={{
          ...
          <p
            className="text-[17.5px] leading-[1.6] max-w-[580px] mt-4"
            style={{ color: "#4C566F" }}
          >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[.9fr_1.1fr] gap-8 items-start">
          ...
          >
            ...
            <div className="relative">
              ...
              <p className="text-[15px] leading-[1.6] mb-8 max-w-[300px]" style={{ color: "#A9B2CC" }}>
